...
Page({
  ...
  pickTicket(e){
    ...
    var url = 'https://' + app.globalData.domainName + '/api/Ticket/GenerateTicketsByUser/' + that.data.templateId + '?sessionKey=' + encodeURIComponent(app.globalData.sessionKey) + '&source=' + encodeURIComponent(source)
    wx.request({
      url: url,
      method: 'GET',
      success:(res)=>{
